...
def record_and_predict_audio(model, Mic_tuning, collection, confidence_threshold=0.85):
    old_direction = None
    is_changed = False
    sampling_interval = 2
...
record_and_predict_audio(model, Mic_tuning, collection, confidence_threshold=0.8)
